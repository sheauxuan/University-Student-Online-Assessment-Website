<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($stmt->execute()) {
            ...
            echo "<script>alert('Study Material created successfully!'); window.location.href='create_study_material.php';</script>";
            exit();
        } else {
            echo "<script>alert('Failed to create module. Please try again.'); window.location.href='create_study_material.php';</script>";
            exit();
        }

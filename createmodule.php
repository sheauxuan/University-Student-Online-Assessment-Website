...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['module_image']) && $_FILES['module_image']['error'] === 0) {
        if ($_FILES['module_image']['size'] > 5000000) { // 5MB limit
    ...
    try {
        ...
        echo "<script>alert('Module created successfully!'); window.location.href='createmodule.php';</script>";
...
<div class="main">
    <div class="create-module-container">
        <h2>Create Module</h2>
        <form id="module-form" action="createmodule.php" method="POST" enctype="multipart/form-data">
